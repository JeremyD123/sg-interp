function w = spquadwgpsp(seq,w1d,id)
% SPQUADWGPSP  Compute quadrature weights, Gauss-Patterson grid 
%    W = SPQUADWGPSP(LEVELSEQ)  Computes the quadrature weights
...
%    does essentially the same as SPQUADWGP, but operates over
